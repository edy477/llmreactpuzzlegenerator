import {Grid, GridOptions} from "@/features/grid/grid";
...
export const placeWordsRandom=(word) =>{

}


export  const generateWordSearch = ({size ,backwards, letters="abcdefghijklmnopqrstuvwxyz",  words =[] }: opts) =>{
